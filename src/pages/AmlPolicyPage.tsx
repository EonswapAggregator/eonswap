...
import { Ban, CheckCircle2, Gavel, Scale, Shield } from 'lucide-react'
    ...
    <section className="relative min-h-screen overflow-hidden border-t border-uni-border">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 md:px-6 md:py-16">
        ...
        >
          ...
          >
            AML <span className="text-uni-pink">policy</span>
          </motion.h1>
        ...
        >
          <div className="relative overflow-hidden rounded-3xl border border-uni-border bg-uni-surface p-6 md:p-8">
            ...
            />
            <div className="relative">
              <p className="text-xs text-neutral-500">Effective date: Apr 10, 2026</p>
              <h3 className="mt-2 text-lg font-semibold text-white">User obligations</h3>
