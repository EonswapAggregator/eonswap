<template>
  <footer class="eonswap-docs-footer">
    ...
    <div class="eonswap-docs-footer__inner">
      ...
      <div class="footer-socials">
        ...
        <a href="https://t.me/eonswap" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="Telegram">
        ...
        <a href="https://discord.gg/AAEq22Sqng" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="Discord">
        ...
        <a href="https://medium.com/@eonswap" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="Medium">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z"/></svg>
        </a>
        <a href="https://github.com/EonswapAggregator/eonswap" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="GitHub">
      ...
      <div class="footer-brand">
        ...
        <span class="brand-name">EonSwap</span>
      </div>
      <p class="eonswap-docs-footer__copyright">
        © {{ year }} EonSwap. All rights reserved.
      </p>
    </div>
  </footer>
</template>
...
.footer-glow {
  ...
  width: 80%;
  height: 1px;
  background: linear-gradient(90deg, transparent, rgba(255, 0, 122, 0.4), transparent);
}

:root:not(.dark) .footer-glow {
  background: linear-gradient(90deg, transparent, rgba(255, 0, 122, 0.3), transparent);
}

.eonswap-docs-footer__inner {
  margin: 0 auto;
...
.eonswap-docs-footer__copyright {
  color: var(--vp-c-text-3);
  font-size: 12px;
  margin: 0;
}
