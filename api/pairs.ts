...
const KNOWN_PAIRS = [
  {
    ...
    token0: '0x7bd09674b3c721e35973993d5b6a79cda7da9c7f', // ESTF
    token1: '0x4200000000000000000000000000000000000006', // WETH
    symbol: 'ESTF/WETH',
  },
  {
    address: '0x1a46207d6c02b95c159ab2f4b8b521b061b49173',
    token0: '0xbc11e3093afdbeb88d32ef893027202fc2b84f9d', // ESR
    token1: '0x4200000000000000000000000000000000000006', // WETH
    symbol: 'ESR/WETH',
  },
]
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    if (pair) {
      ...
      if (!pairData) {
        return res.status(404).json({ error: 'Pair not found or has no liquidity' })
      }
